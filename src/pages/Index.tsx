    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[
            ...
            { name: "Business", price: "0.40", desc: "Per SMS segment", features: ["Volume discounts", "Custom sender IDs", "Priority support", "Delivery reports"], popular: true },
            { name: "Enterprise", price: "Custom", desc: "Contact us", features: ["Dedicated account", "SLA guarantee", "Custom integration", "White-label options"] },
          ].map((plan) => (
      ...
      <footer className="border-t border-border/50 py-8">
        <div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} ABAN SMS. Built for Kenya 🇰🇪
        </div>
      </footer>
    </div>
  );
